...
exports.signup = async (req, res) => {
  ...
  res
    .status(200)
    .json({ message: "Signup process is successfull. Please sign in!" });
};
...
exports.signin = (req, res) => {
  ...
  User.findOne({ email }, (err, user) => {
    ...
    // create auth method in user model an use here
    ...
    // persist the token as "t" in cockie with expiry date
...
exports.signout = (req, res) => {
  // clearing the cookie signs out the user
  res.clearCookie("t");
...
exports.requireSignin = expressJwt({
  ...
  // in a auth key to the request object
